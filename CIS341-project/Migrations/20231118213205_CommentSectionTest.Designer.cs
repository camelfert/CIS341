...
namespace CIS341_project.Migrations
{
    ...
    [Migration("20231118213205_CommentSectionTest")]
    partial class CommentSectionTest
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CIS341_project.Models.Comment", b =>
                {
                    ...
                    b.Property<int>("AuthorAccountId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CIS341_project.Models.Comment", b =>
                {
                    b.HasOne("CIS341_project.Models.Account", "Author")
                        .WithMany()
                        .HasForeignKey("AuthorAccountId1")
